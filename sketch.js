...
function setup() {
  ...
  box16 = new YellowBox(530,290,20,30);
  box17 = new RedBox(550,290,20,30);
  box18 = new GreenBox(570,290,20,30);

  box19 = new BlueBox(540,260,20,30);
  box20 = new RedBox(560,260,20,30);
  
  box21 = new GreenBox(550,230,20,30);
  ...
  box40 = new GreenBox(550,35,20,30);
